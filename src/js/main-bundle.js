...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsDefaultApp = __webpack_require__(161);

	var _componentsDefaultApp2 = _interopRequireDefault(_componentsDefaultApp);

	var _componentsDefaultIndexPage = __webpack_require__(164);

	var _componentsDefaultIndexPage2 = _interopRequireDefault(_componentsDefaultIndexPage);

	var _componentsDefaultExamplesPage = __webpack_require__(168);

	var _componentsDefaultExamplesPage2 = _interopRequireDefault(_componentsDefaultExamplesPage);

	var _componentsDefaultSkillsPage = __webpack_require__(153);

	var _componentsDefaultSkillsPage2 = _interopRequireDefault(_componentsDefaultSkillsPage);

	var _componentsDefaultAboutPage = __webpack_require__(169);

	var _componentsDefaultAboutPage2 = _interopRequireDefault(_componentsDefaultAboutPage);

	//Game Pages

	var _componentsGameIndexPage = __webpack_require__(170);

	var _componentsGameIndexPage2 = _interopRequireDefault(_componentsGameIndexPage);

	var _componentsGameExamplesPage = __webpack_require__(173);

	var _componentsGameExamplesPage2 = _interopRequireDefault(_componentsGameExamplesPage);

	var _componentsGameSkillsPage = __webpack_require__(174);

	var _componentsGameSkillsPage2 = _interopRequireDefault(_componentsGameSkillsPage);

	var _componentsDefaultAboutPage3 = _interopRequireDefault(_componentsDefaultAboutPage);
	...
	function getComponent(pagename, subpage) {
		...
		switch (pagename) {
			case '/':
				component = env === 'normal' ? _react2['default'].createElement(_componentsDefaultIndexPage2['default'], null) : _react2['default'].createElement(_componentsGameIndexPage2['default'], null);
				break;
			case 'skills':
				component = env === 'normal' ? _react2['default'].createElement(_componentsDefaultSkillsPage2['default'], { subpage: subpage ? subpage : null }) : _react2['default'].createElement(_componentsGameSkillsPage2['default'], { subpage: subpage ? subpage : null });

				break;

			case 'examples':
				component = env === 'normal' ? _react2['default'].createElement(_componentsDefaultExamplesPage2['default'], { subpage: subpage ? subpage : null }) : _react2['default'].createElement(_componentsGameExamplesPage2['default'], { subpage: subpage ? subpage : null });
				break;

			case 'about':
				component = env === 'normal' ? _react2['default'].createElement(_componentsDefaultAboutPage2['default'], { subpage: subpage ? subpage : null }) : _react2['default'].createElement(_componentsDefaultAboutPage3['default'], { subpage: subpage ? subpage : null });
				break;

			case 'ember':
				component = _react2['default'].createElement(EmberPage, { subpage: subpage ? subpage : null });
	...
	(0, _page2['default'])('/', function (req, res) {
		console.log('routing index');
		_react2['default'].render(_react2['default'].createElement(_componentsDefaultApp2['default'], { id: 'app', env: env, pagename: '/', subpage: '' }), document.getElementById('app'));
	});
	(0, _page2['default'])('/skills', function (req, res) {
		console.log('routing skills');
		_react2['default'].render(_react2['default'].createElement(_componentsDefaultApp2['default'], { id: 'app', env: env, pagename: 'skills', subpage: '' }), document.getElementById('app'));
	});
	...
	(0, _page2['default'])('/ember', function (req, res) {
		...
		_react2['default'].render(_react2['default'].createElement(_componentsDefaultApp2['default'], { id: 'app', env: env, pagename: 'ember', subpage: '' }), document.getElementById('app'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SkillInfo = __webpack_require__(154);

	var _SkillInfo2 = _interopRequireDefault(_SkillInfo);

	var _skills = __webpack_require__(156);
	...
	var SkillsPage = (function (_React$Component) {
	    function SkillsPage(props) {
	        ...
	        _get(Object.getPrototypeOf(SkillsPage.prototype), 'constructor', this).call(this, props);
	        this.state = { currentSkill: _skills2['default'][0].img };
	    }
	    ...
	    _createClass(SkillsPage, [{
	        ...
	        value: function render() {
	            var title = 'Responsive HTML5';
	            var clickHandler = this.changeSkill.bind(this);
	            var _state$currentSkill = this.state.currentSkill;
	            //get info of currently selected skill
	            var currentSkill = _state$currentSkill === undefined ? 'node' : _state$currentSkill;

	            var _characters$find = _skills2['default'].find(function (skill) {
	                return skill.img === currentSkill;
	            });

	            var _characters$find$name = _characters$find.name;
	            var name = _characters$find$name === undefined ? 'node' : _characters$find$name;
	            var _characters$find$txt = _characters$find.txt;
	            var txt = _characters$find$txt === undefined ? 'txt' : _characters$find$txt;
	            var _characters$find$img = _characters$find.img;
	            var img = _characters$find$img === undefined ? 'node' : _characters$find$img;
	            var _characters$find$examples = _characters$find.examples;
	            var examples = _characters$find$examples === undefined ? [] : _characters$find$examples;

	            return _react2['default'].createElement(
	                'div',
	                { className: 'SkillsPage-default page' },
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'SkillsPage-default-container' },
	                    _react2['default'].createElement(
	                        'h1',
	                        { id: 'playerSelect' },
	                        'Skills'
	                    ),
	                    _react2['default'].createElement(_SkillInfo2['default'], { name: name, txt: txt, img: img, examples: examples }),
	                    _react2['default'].createElement(
	                        'div',
	                        { id: 'skillWrapper' },
	                        _skills2['default'].map(function (skill, index) {
	                            var _skill$name = skill.name;
	                            var name = _skill$name === undefined ? 'node' : _skill$name;
	                            var _skill$img = skill.img;
	                            var img = _skill$img === undefined ? 'node' : _skill$img;
	                            var bgtxt = 'url(\'/src/images/logo-' + img + '.svg\')';
	                            return _react2['default'].createElement(
	                                'a',
	                                { name: name, id: name, key: index, index: index, 'data-index': index, className: 'skill', href: '/skills#' + name, onClick: clickHandler, style: { backgroundImage: bgtxt } },
	                                _react2['default'].createElement('img', { alt: img })
	                            );
	                        })
	                    )
	                )
	        ...
	        value: function changeSkill(ev) {
	            var _ev$target$dataset$index = ev.target.dataset.index;
	            var index = _ev$target$dataset$index === undefined ? 0 : _ev$target$dataset$index;

	            this.setState({
	                currentSkill: _skills2['default'][index].img
	            });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DescriptionBox = __webpack_require__(155);

	var _DescriptionBox2 = _interopRequireDefault(_DescriptionBox);

	//@withStyles(styles)

	var SkillInfo = (function () {
	  function SkillInfo() {
	    _classCallCheck(this, SkillInfo);
	  }

	  _createClass(SkillInfo, [{
	    key: 'render',
	    ...
	    value: function render() {
	      ...
	      var name = _props$name === undefined ? 'node' : _props$name;
	      var _props$img = _props.img;
	      var img = _props$img === undefined ? 'node' : _props$img;
	      var _props$txt = _props.txt;
	      var txt = _props$txt === undefined ? '' : _props$txt;
	      var _props$examples = _props.examples;
	      var examples = _props$examples === undefined ? [] : _props$examples;

	      return _react2['default'].createElement(
	        'div',
	        { className: 'SkillInfo-default' },
	        _react2['default'].createElement(
	          'div',
	          { className: 'SkillInfo-container' },
	          _react2['default'].createElement(
	            'div',
	            { className: 'skillImg', style: { backgroundImage: 'url(\'/src/images/logo-' + img + '.svg\')' } },
	            _react2['default'].createElement('img', { alt: 'skill' })
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'skillText' },
	          ...
	          _react2['default'].createElement(
	            'div',
	            { className: 'skillTextExample' },
	            _react2['default'].createElement(
	              'h4',
	              { className: 'skillTextHeader' },
	              'Examples'
	            ),
	            _react2['default'].createElement(
	              'p',
	            ...
	            _react2['default'].createElement(
	              'p',
	              { className: 'skillTextExampleBody' },
	              examples.map(function (example) {
	                _react2['default'].createElement(_DescriptionBox2['default'], null);
	              })
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(DescriptionBox, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'DescriptionBox-container' },
	          _react2['default'].createElement(
	            'div',
	            { className: 'Header-Container' },
	            _react2['default'].createElement(Header, { key: 'head' })
	          )
	        )
	      );
	    }
	...
	exports['default'] = DescriptionBox;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    var _props = this.props;
	    var _props$pagename = _props.pagename;
	    var pagename = _props$pagename === undefined ? '/' : _props$pagename;
	    var _props$subpage = _props.subpage;
	    var subpage = _props$subpage === undefined ? '' : _props$subpage;
	    var component = _router2['default'].getComponent(pagename, subpage);
	    return _react2['default'].createElement(
	      'div',
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            "i",
	            null,
	            "Copyright LeRenzo Malcom 2015"
	          ),
	          _react2["default"].createElement(
	            "a",
	            { href: "mailto:Lmalcom@post.harvard.edu" },
	            "    Lmalcom@post.harvard.edu"
	          ),
	          _react2["default"].createElement(
	            "div",
	            { className: "social" },
	            _react2["default"].createElement("a", { href: "https://www.linkedin.com/pub/lerenzo-tolbert-malcom/12/696/876", className: "btn-linkedin btn", style: { backgroundImage: "url('/src/images/icons/linkedin2.svg')" } }),
	            _react2["default"].createElement("a", { href: "https://github.com/lmalcom/", className: "btn-github btn", style: { backgroundImage: "url('/src/images/icons/github4.svg')" } }),
	            _react2["default"].createElement("a", { href: "https://twitter.com/lerenzom", className: "btn-twiter btn", style: { backgroundImage: "url('/src/images/icons/bird.svg')" } }),
	            _react2["default"].createElement("a", { href: "mailto:Lmalcom@post.harvard.edu", className: "btn-twiter btn", style: { backgroundImage: "url('/src/images/icons/envelope.svg')" } })
	          )
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactFitterHappierText = __webpack_require__(165);

	var _reactFitterHappierText2 = _interopRequireDefault(_reactFitterHappierText);
	...
	var IndexPage = (function (_React$Component) {
	    ...
	    _createClass(IndexPage, [{
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                'div',
	                { className: 'IndexPage page' },
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'IndexPage-default' },
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'IndexPage-default-body' },
	                        _react2['default'].createElement(
	                            'div',
	                            { className: 'textBox' },
	                            _react2['default'].createElement(
	                                ...
	                                _react2['default'].createElement(
	                                    ...
	                                    { id: 'catchphrase-1' },
	                                    'I ',
	                                    _react2['default'].createElement('span', { className: 'heart-txt' }),
	                                    ' tech'
	                                )
	                            ),
	                            _react2['default'].createElement(
	  ...
	  _createClass(FitterHappierText, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement('svg', _extends({}, this.props, {
	        viewBox: viewBox,
	        style: styles.svg }), _react2['default'].createElement('text', {
	        ref: 'text',
	        x: '50%',
	...
	var ExamplesPage = (function () {
	  ...
	  _createClass(ExamplesPage, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        { className: 'ExamplesPage page' },
	        _react2['default'].createElement(
	          'div',
	          { className: 'ExamplesPage-container' },
	          _react2['default'].createElement(
	            'h1',
	            null,
	            'Examples'
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement('iframe', { width: '50%', height: '360', src: 'https://www.youtube.com/embed/tL06lRCVoi4', allowfullscreen: '1' }),
	            _react2['default'].createElement('iframe', { width: '50%', height: '360', src: 'https://www.youtube.com/embed/WUAEqdsylCw', allowfullscreen: '1' }),
	            _react2['default'].createElement(
	              'p',
	              null,
	            ...
	            _react2['default'].createElement(
	              'p',
	              null,
	              'I have a passion for live-streaming data and am always looking for more ways to improve\n                the web with small features that will make the page seem more alive.'
	            )
	          ),
	          _react2['default'].createElement(
	            'div',
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement('img', { src: '/src/images/lsd2.png' }),
	            _react2['default'].createElement('img', { src: '/src/images/lsd1.png' }),
	            _react2['default'].createElement(
	              'p',
	              null,
	              'Worked on revamping the ',
	              _react2['default'].createElement(
	                'a',
	                { target: '_blank', href: 'http://electiontimeline.com/l/n2FF3svcvI' },
	                'front end component system'
	              ),
	              ' to be more reusable. This was goingto be rolled out on a few projects. Here I got the opportunity to work on some interesting Data Viz project and fun stuff in processing.` }'
	            )
	          )
	        )
	      );
	    ...
	    value: function render() {
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            "a",
	            { className: "resume", href: "/src/pdf/resume2015.pdf" },
	            "[Resume]"
	          )
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TesselateContainer = __webpack_require__(171);

	var _TesselateContainer2 = _interopRequireDefault(_TesselateContainer);
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(_Header2['default'], { key: 'head' })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TesselateContainer = (function () {
	  function TesselateContainer() {
	    _classCallCheck(this, TesselateContainer);
	  }

	  _createClass(TesselateContainer, [{
	    key: 'render',
	    ...
	    value: function render() {
	      ...
	      var header = _props$header === undefined ? 'Tess' : _props$header;
	      var _props$bgimg = _props.bgimg;
	      var bgimg = _props$bgimg === undefined ? '/public/tile.png' : _props$bgimg;
	      var _props$link = _props.link;
	      var link = _props$link === undefined ? '/' : _props$link;
	      var _props$txt = _props.txt;
	      var txt = _props$txt === undefined ? 'lipsumf weoifjweofiwjfiojw' : _props$txt;
	      var bgtxt = 'url(\'' + bgimg + '\'\')';

	      return _react2['default'].createElement(
	        'a',
	        { className: 'TesselateContainer', href: link, style: { backgroundImage: bgtxt } },
	        _react2['default'].createElement(
	          'h3',
	          { className: 'TessalateHeader' },
	          header
	        )
	      );
	    }
	  ...
	  return TesselateContainer;
	})();

	exports['default'] = TesselateContainer;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InteractivePage = (function () {
	  function InteractivePage() {
	    _classCallCheck(this, InteractivePage);
	  }

	  _createClass(InteractivePage, [{
	    key: 'render',
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        'div',
	        { className: 'InteractivePage' },
	        _react2['default'].createElement(
	          'div',
	          { className: 'InteractivePage-container' },
	          _react2['default'].createElement(
	            'h1',
	            null,
	            title
	...
	exports['default'] = InteractivePage;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SkillInfo = __webpack_require__(175);
	...
	var ResponsivePage = (function (_React$Component) {
	    function ResponsivePage(props) {
	        _classCallCheck(this, ResponsivePage);

	        _get(Object.getPrototypeOf(ResponsivePage.prototype), 'constructor', this).call(this, props);
	        var page = this;
	        this.state = { currentSkill: _skills2['default'][0].img };
	    }

	    _inherits(ResponsivePage, _React$Component);

	    _createClass(ResponsivePage, [{
	        key: 'makeWorld',
	        value: function makeWorld() {
	            ...
	            var svg = d3.select(document.getElementById('d3-container')).append('svg').attr('width', width).attr('height', height);

	            svg.append('path').datum(graticule).attr('class', 'graticule').attr('d', path);

	            if (worldjson) {

	                svg.insert('path', '.graticule').datum(topojson.feature(worldjson, worldjson.objects.land)).attr('class', 'land').attr('d', path);

	                svg.insert('path', '.graticule').datum(topojson.mesh(worldjson, worldjson.objects.countries, function (a, b) {
	                    return a !== b;
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                'div',
	                { className: 'ResponsivePage', special: 'whaaaa?' },
	                _react2['default'].createElement(
	                    'h1',
	                    { id: 'playerSelect' },
	                    'Skill Select!'
	                ),
	                _react2['default'].createElement('div', { id: 'd3-container' }),
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'ResponsivePage-container' },
	                    _react2['default'].createElement(
	                        'div',
	                        { id: 'skillWrapper' },
	                        _skills2['default'].map(function (skill, index) {
	                            ...
	                            return _react2['default'].createElement(
	                                'a',
	                                { name: name, id: name, key: index, index: index, 'data-index': index, className: 'skill', href: '/responsive#' + name, onClick: clickHandler, style: { backgroundImage: bgtxt } },
	                                _react2['default'].createElement('img', { alt: img })
	                            );
	                        })
	                    )
	...
	exports['default'] = ResponsivePage;
	module.exports = exports['default'];
	//find that in the array
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DescriptionBox = __webpack_require__(176);
	  ...
	  _createClass(SkillInfo, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'SkillInfo-container-default' },
	          _react2['default'].createElement(
	            'div',
	            { className: 'skillImg', style: { backgroundImage: 'url(\'/src/images/logo-' + img + '.svg\')' } },
	            _react2['default'].createElement('img', { alt: 'skill' })
	          ...
	          _react2['default'].createElement(
	            'div',
	            { className: 'skillText-default' },
	            _react2['default'].createElement(
	              'h4',
	              { className: 'header' },
	              name
	            ),
	            _react2['default'].createElement('p', { className: 'skillTextBody-default' })
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'skillTextExample-default' },
	            _react2['default'].createElement(
	              'h4',
	              { className: 'skillTextHeader-default' },
	              'Examples'
	            ),
	            _react2['default'].createElement(
	              'p',
	              { className: 'skillTextExampleBody-default' },
	              examples.map(function (example) {
	                _react2['default'].createElement(_DescriptionBox2['default'], null);
	              })
	            )
